...
<title>MPB - Site Único de V para M</title>
<style>
body {
    font-family: Arial, sans-serif;
    margin: 0;
    background: linear-gradient(to bottom, #f4ecd8, #e0c097);
    color: #333;
...
.letra { line-height: 1.8; white-space: pre-wrap; }
.dedicatoria {
    margin-top: 30px;
    font-style: italic;
    font-size: 1.2rem;
...
/* Fundo animado romântico para Disritmia */
#disritmia {
    background: linear-gradient(135deg, rgba(255,182,193,0.2), rgba(255,105,180,0.2), rgba(255,182,193,0.2));
